  ...
  render() {
    return (
      <div className="MainPageInfo">
        <h2>
          Finding the right puppy can be dog gone hard work. We provides a
          convenient and efficient means of selecting and purchasing the perfect
          four-legged friend from the comfort of your home, 24 hours a day, 7
          days a week. Take advantage of our adoption site or leisurely browse
          our directory of dog and cat breeds with photos and detailed
